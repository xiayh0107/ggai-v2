...
import type { TrustedTaskProposal } from '@/canvas/commands'
import CanvasProposalReviewPanel from './CanvasProposalReviewPanel'

const proposals: TrustedTaskProposal[] = [
  {
    key: 'prepare',
    title: '整理数据',
    prompt: '清理并整理原始数据。',
...
function renderSubject(settledProposalKeys: readonly string[] = []) {
  ...
  return { host: required<HTMLElement>('[data-testid="canvas-proposal-review-panel"]'), onAccept, onReject }
}
...
describe('CanvasProposalReviewPanel', () => {
